...
var AudioInputTypeOptions = [
	...
	{ id: '37', label: 'XLR-Line' },
	{ id: '38', label: 'XLR-Mic' },
	{ id: '39', label: 'USB Audio' },
	{ id: '3a', label: 'Follow' },
];
...
var XLRPowerOptions = [
	{ id: '30', label: 'XLR power left right off' },
	{ id: '33', label: 'XLR power left right ON' },
];
...
var actions =
{
	...
	'XLRInputMode': {
		label: 'XLR Input Mode',
		options: [
			{
				type: 'dropdown',
				label: 'XLR Input',
				id: 'val',
				choices: XLRInputOptions,
			}
		]
	},

	'XLRPowerMode': {
		label: 'XLR Power Mode',
		options: [
			{
				type: 'dropdown',
				label: 'XLR Power',
				id: 'val',
				choices: XLRPowerOptions,
			}
		]
	},
